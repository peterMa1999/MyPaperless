 ...
 */
public class Examine_all_itemActivity_tiqian extends BaseActivity {
	private Context context = Examine_all_itemActivity_tiqian.this;
	...
	private String section,workStation;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AppManager.getInstance().addActivity(
				Examine_all_itemActivity_tiqian.this);
		user = (UserBean) getApplicationContext();
		CheckLogin();
		Intent intent = getIntent();
		section = intent.getStringExtra("section");
		head_title = (TextView) findViewById(R.id.head_title);
		head_title.setText("提前維護線體報表");
				...
				if (key.equals(MyConstant.GET_CHECK_REPORT_SECTION)) {
					...
					if (result.get(0).toString()
						...
						intent = new Intent(context,
								Examine_in_advance_Activity.class);
