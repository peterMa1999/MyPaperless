...
{
	public static final String IMAGE_PATH = "Mypaperless-photo";
	private static String localTempImageFileName = "";
	public static final File FILE_SDCARD = Environment.getExternalStorageDirectory();
	public static final File FILE_LOCAL = new File(FILE_SDCARD,IMAGE_PATH);
	public static final File FILE_PIC_SCREENSHOT = new File(FILE_LOCAL,"images/myself");
...
//                mRunFaceDetection.run();
	...
	private void startFaceDetection() {
        ...
        showProgressDialog("請稍後...", new Runnable() {
            public void run() {
                final CountDownLatch latch = new CountDownLatch(1);
...
//        Rect dr = mCrop.mDrawRect;
    ...
    public String saveToLocal(Bitmap bm,String photoname)
    {
    	localTempImageFileName = "";
//		localTempImageFileName = String.valueOf((new Date())
//				.getTime()) + ".png";
		localTempImageFileName = photoname+ ".png";
