package com.gitonway.circularprogressbutton;
...
public class CircularProgressButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int yellowb = getColor(R.color.yellowb);
            int red = getColor(R.color.redb);
            int green = getColor(R.color.greenb);
            int white = getColor(R.color.whiteb);
            int grey = getColor(R.color.greyb);

            mColorIdle = attr.getColor(R.styleable.CircularProgressButton_colorIdle, yellowb);
            ...
            mColorIndicator = attr.getColor(R.styleable.CircularProgressButton_colorIndicator, yellowb);
